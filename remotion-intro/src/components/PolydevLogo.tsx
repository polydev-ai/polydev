...
// The actual Polydev logo - an abstract "A" made of triangular shapes
export const PolydevLogo: React.FC<PolydevLogoProps> = ({
  size = 120,
  animate = true,
  showText = true,
  color = "#0f172a",
  ...
  return (
    ...
    >
      {/* Actual Polydev Logo - Abstract A shape */}
      <svg
        width={size}
        height={size}
        viewBox="0 0 600 600"
...
// Polydev logo with tagline
export const PolydevLogoFull: React.FC<{ size?: number; animate?: boolean }> = ({
  size = 80,
  animate = true,
}) => {
  const frame = useCurrentFrame();
  ...
  return (
    ...
    >
      <PolydevLogo size={size} animate={animate} />
      <p
        style={{
          fontSize: size * 0.22,
          color: "#64748b",
