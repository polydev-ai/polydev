          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">${creditBalance.balance.toFixed(2)}</p>
                {creditBalance.promotionalBalance > 0 && (<p className="text-xs text-blue-100">+${creditBalance.promotionalBalance.toFixed(2)} promotional</p>)}
              </div>
