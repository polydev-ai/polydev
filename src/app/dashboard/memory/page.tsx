      ...
      <div className="max-w-7xl mx-auto p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-4 flex items-center">
            <Shield className="w-8 h-8 mr-3 text-slate-900" />
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-slate-600">
                ...
                <p className="mt-2">
                  ...
                  (stored in <code className="bg-slate-100 px-1 rounded">~/.claude/projects/*.jsonl</code>).
                </p>
                <p className="mt-2">
              ...
              <div className="mt-4">
                <div className="text-sm">
                  <p className="font-medium text-slate-900 mb-2">To reactivate (for developers):</p>
                  <ol className="list-decimal list-inside text-slate-600 space-y-1">
                    <li>Set <code className="bg-slate-100 px-1 rounded">isFeatureDisabled = false</code> in this component</li>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-slate-600">
            ...
            <code className="bg-slate-100 px-1 rounded ml-1">CLAUDE_CODE_MCP_CONTEXT_ANALYSIS.md</code>
          </p>
        </div>
      </div>
    )
    ...
    <div className="max-w-7xl mx-auto p-8">
      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-slate-900 bg-white"
          />
          <button
            onClick={() => handleSearch(searchQuery)}
            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-slate-900 hover:bg-slate-700 text-white px-4 py-1.5 rounded text-sm"
          >
            Search
          </button>
        </div>
      ...
      <div className="mb-6 flex justify-end">
        <button
          ...
          className="inline-flex items-center px-4 py-2 border border-slate-200 rounded-md shadow-sm text-sm font-medium text-slate-900 bg-white hover:bg-slate-100"
        >
        ...
        <div className="space-y-4">
          {memories.conversations.length === 0 ? (
            ...
            memories.conversations.map((conv) => (
              <div
                key={conv.id}
                className="bg-white rounded-lg shadow border border-slate-200 p-6 cursor-pointer hover:shadow-md transition-shadow"
                onClick={() => {
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <div className="text-sm font-medium text-slate-900 mb-1">User:</div>
                  ...
                  <div>
                    <div className="text-sm font-medium text-slate-900 mb-1">Assistant:</div>
                    <div className="bg-slate-50 rounded-md p-3 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {memories.projectMemories.length === 0 ? (
            ...
            memories.projectMemories.map((memory) => (
              <div
                key={memory.id}
                className="bg-white rounded-lg shadow border border-slate-200 p-4 cursor-pointer hover:shadow-md transition-shadow"
                onClick={() => {
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <div className="flex items-center space-x-2 text-xs text-slate-600">
                      <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-slate-100 text-slate-900">
                        {memory.memory_type}
                      </span>
                    </div>
                  </div>
            ...
            <div className="p-6">
              {'user_message' in selectedMemory ? (
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="font-medium text-slate-900 mb-3">User Message:</h3>
                  ...
                  <div>
                    <h3 className="font-medium text-slate-900 mb-3">Assistant Response:</h3>
                    <div className="bg-slate-50 rounded-md p-4 text-sm whitespace-pre-wrap max-h-96 overflow-y-auto">
