    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              >
                {Object.entries(CLINE_PROVIDERS).map(([id, config]) => (
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
              >
                {Object.entries(CLINE_PROVIDERS[preferences.default_provider as keyof typeof CLINE_PROVIDERS]?.supportedModels || {}).map(([modelId, model]) => (
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          ...
          <div className="space-y-4">
            {Object.entries(CLINE_PROVIDERS).map(([providerId, config]) => (
