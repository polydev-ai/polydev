...
import { ArrowLeft, Search, Target, Zap, Clock, RefreshCw, User, Mail, Calendar, Edit } from 'lucide-react'
          ...
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Manage user perspective quotas and limits</p>
              </div>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{stats.totalPremiumUsage}</p>
                <p className="text-xs text-gray-500">High-tier model perspectives</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Normal Usage</p>
                <p className="text-2xl font-bold text-gray-900">{stats.totalNormalUsage}</p>
                <p className="text-xs text-gray-500">Mid-tier model perspectives</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Eco Usage</p>
                <p className="text-2xl font-bold text-gray-900">{stats.totalEcoUsage}</p>
                <p className="text-xs text-gray-500">Low-tier model perspectives</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Eco</th>
                ...
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      user.plan_tier === 'plus' ? 'bg-blue-100 text-blue-800' :
