        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-6 text-white">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-100 text-sm">Model Context Protocol</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex space-x-3">
            <button
              ...
              disabled={loading}
              className="flex-1 bg-slate-900 text-white py-2 px-4 rounded-lg font-medium hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <div className="mt-6 text-xs text-slate-500 text-center">
            <p>
              ...
              <a href="/dashboard/mcp-tokens" className="text-slate-600 hover:underline">
