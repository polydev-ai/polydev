      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <span className={`inline-block w-12 text-xs font-mono ${
                          ep.method === 'GET' ? 'text-slate-600' :
                          ep.method === 'POST' ? 'text-slate-600' : 'text-slate-600'
                        }`}>
                          {ep.method}
                        </span>
                        <span className="text-slate-900 mr-2">{ep.path}</span>
                        <span className="text-slate-500 text-xs">{ep.description}</span>
                      </div>
                      {ep.requiresAuth && (
                ...
                {Object.entries(request.headers).map(([key, value]) => (
                  <div key={key} className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-2 py-2 text-slate-600 hover:text-slate-500"
                    >
                      ×
                    </button>
                  </div>
            ...
            {response ? (
              <div>
                ...
                <div className="mb-4">
                  ...
                  <div className="bg-slate-100 rounded-md p-3 max-h-32 overflow-y-auto">
                ...
                <div>
                  ...
                  <div className="bg-slate-100 rounded-md p-3 max-h-96 overflow-y-auto">
        ...
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="font-medium text-slate-900">Rate Limits</h3>
              <p className="text-sm text-slate-600">
            ...
            <div>
              <h3 className="font-medium text-slate-900">Error Responses</h3>
              <p className="text-sm text-slate-600">
