...
`;
  ...
  /**
   * GSTREAMER TEST: Test 8: vp8enc with all properties
   ...
   * Tests full pipeline without RTP payloader
   */
    ...
    const gstPipeline = [
      'gst-launch-1.0',
      '-v',
      `ximagesrc ! video/x-raw,framerate=30/1 ! videoscale ! video/x-raw,width=1280,height=720 ! vp8enc target-bitrate=2000000 deadline=1 cpu-used=4 ! fakesink`
    ];
